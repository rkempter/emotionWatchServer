# project noname (0.0.9) configured on Wed Nov  7 10:59:37 2012 by
# waf 1.5.16 (abi 7, python 20702f0 on darwin)
# using /usr/local/Cellar/node/0.8.9/bin/node-waf configure build
#
...
ok /usr/local/Cellar/node/0.8.9
