...
CPPPATH_NODE = '/usr/local/Cellar/node/0.8.9/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
...
LIBDIR = '/Users/rkempter/.node_libraries'
LIBPATH_NODE = '/usr/local/Cellar/node/0.8.9/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-arch', 'x86_64']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/rkempter/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.8.9'
