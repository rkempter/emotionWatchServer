...
Connection.prototype.queryData = function(startDateTime, endDateTime, keyword, step, response, callback) {
    ...
    if(hour > 1) {
      timeQuery =  "EXTRACT(HOUR FROM wo.`dateTime`) DIV "+hour+" * "+hour+" AS hour, "+
 ...
 */
Connection.prototype.getFrequency = function(step, keyword, startDateTime, endDateTime, response, callback) {
